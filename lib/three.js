...
require('../node_modules/three-dev/examples/js/loaders/gltf/glTF-parser');
require('../node_modules/three-dev/examples/js/loaders/gltf/glTFLoader');
require('../node_modules/three-dev/examples/js/loaders/gltf/glTFLoaderUtils');
require('../node_modules/three-dev/examples/js/loaders/gltf/glTFAnimation');
